...
var insertar={
  "Titulo" : "Java vs .NET",
        "Parrafo" : "Java es un excelente lenguaje de programación, JavaSE/JavaEE es una excelente plataforma de desarrollo. Pertenece a un grande de la industria como es Oracle, además de contar el respaldo de gigantes como IBM, RedHat, entre otros. Además, en sus últimas versiones el lenguaje Java ha implementado muchas funcionalidades que ya estaban presentes en .NET, lo que contribuye un poco a quitarle esa fama de dinosaurio que se había ganado últimamente. Finalmente, el crecimiento de Android le ha dado un empuje (algo indirecto, pero real) a la plataforma.",
        "Parrafo_principal" : [
                ...
                "Con este artículo quise hacer una breve reflexión sobre esta discusión, no con el ánimo de imponer mi forma de pensar o mis opiniones, sino para contribuir a que los debates sobre este tema sean más prácticos y sustentables. "
        ],
        "Autor" : "Ivan sergio lopez",
        "Fecha" : new Date(),
        "id_articulo" : 20,
        "id_categoria" : 1,
        "imagen" : "imagen20.jpg",
        "video" : "https://www.youtube.com/embed/2dlYXsCLEMk",
        "__v" : 0
 }

db.articulos.insert(insertar);
*/
